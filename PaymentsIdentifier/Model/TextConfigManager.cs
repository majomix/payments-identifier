...
namespace DotNet.Config
{
    public class AppSettings
    {
        ...
        private static string defaultConfigFileName = "customer.properties";
        ...
        public static void GlueOnto(object o, string configFile)
        {
            ...
            foreach (var pair in appSettings)
            {
                ...
                if (fieldInfo == null && name.Contains("."))
                {
                    ...
                    propertyInfo = o.GetType().GetProperty(listName);
                }
                ...
                Type ft = fieldInfo == null ? propertyInfo.PropertyType : fieldInfo.FieldType;
